...
export const BLOGS: BlogPost[] = [
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "or self-employed people, your base income for ACA purposes is your net self employment income (profit after business deductions).",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "f you bill $80,000 this year, but you spend $30,000 on software, travel, contract labor, and office supplies, your starting income for the ACA application is $50,000, not $80,000.",
      },
        ...
        items: [
          {
            ...
            text: " You’ll get larger subsidies up front, but you may have to pay some (or all) of that money back to the IRS when you file your taxes",
          },
          {
            bold: "If you overestimate your income:",
            text: " You’ll pay higher monthly premiums during the year, but you’ll get the difference back as a tax refund when you file.",
          },
        ],
      },
      {
      ...
      {
        type: "pro_tip",
        text: " if your income changes significantly. You don't have to wait until open enrollment if you sign a massive contract in June or lose a client in August, log into your account and update your estimated income right away to recalculate your monthly subsidy.",
      },
