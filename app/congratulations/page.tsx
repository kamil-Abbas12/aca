    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white px-4 py-10">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-sm text-gray-700 mb-4">
          <span className="text-[#f5a623] font-semibold">Healthcare.com</span>{" "}
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {[
            ...
            <div key={stat.label}>
              <p className="text-2xl font-extrabold text-[#1e2a4a]">{stat.value}</p>
        ...
        <p className="text-gray-500 text-sm">
          Based on your profile, these offers may help fill gaps in your coverage.
          We've already filled in most of the details.
        </p>
      </div>
    </main>
  );
